...
In the realm of artificial intelligence, collaboration emerges as the driving force behind innovation and progress. 
DeepLearning.AI thrives on the synergy generated by uniting a diverse array of experts, ranging from seasoned professionals to aspiring enthusiasts. 
Through a tapestry of collaborative projects, workshops, and forums, the collective intelligence cultivated within our community tackles intricate 
AI challenges head-on. By fostering a culture where minds converge, expertise merges, and knowledge proliferates, we pave the way for an 
AI landscape teeming with breakthroughs. Join us on this transformative journey that envisions a future in which collaboration ushers 
in unparalleled advancements in AI technology.
"""
# In[2]:
task = f'''
